...
%----------- About -----------
\begin{center}
Full-stack software engineering with experience at Criteo and IBM. Currently, interested in contributing to solutions for different industries using state-of-art technologies such as Generative AI and XR. Given my multi-stack experience, I'm open and able to learn quickly new tools and techniques.
\end{center}
%----------- EMPLOYMENT -----------
\section{Employment}
  \vspace{5pt}
