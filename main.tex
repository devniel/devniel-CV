...
\section{Education}
  ...
  \resumeSubHeadingListStart
    \resumeEducationHeading
      ...
      {Bachelor of Science in Systems Engineering. \textbf{GPA: 15/20}}{Aug 2008 \textbf{--} Jun 2014}
    ...
    \resumeSubHeadingListStart
      ...
      {\textbf{Clapper.app - Contributions to open source project via Github (August 2024)}}{}
        \resumeItemListStart
          ...
          \resumeItem{Mainly contributed with the video export to MP4, the local ComfyUI workflow integration and other fixes.}
